...
entity vid_out_v1_0_S00_AXIS is
	generic (
...
end vid_out_v1_0_S00_AXIS;

architecture arch_imp of vid_out_v1_0_S00_AXIS is
...
begin
	...
	-- Add user logic here
	OUTPUT_GEN: for byte_index in 0 to NUMBER_OF_INPUT_WORDS-1 generate
	begin
	 
	 process(writes_done)
	 begin
	   if (writes_done = '1') then
	     vid_pixel(byte_index*8+7 downto byte_index*8) <= stream_data_fifo(byte_index);
	   end if;
	 end process;
