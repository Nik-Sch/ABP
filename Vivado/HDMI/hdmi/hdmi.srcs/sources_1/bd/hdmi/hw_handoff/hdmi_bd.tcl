...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_SCL_INERTIAL_DELAY {1} \
   CONFIG.C_SDA_INERTIAL_DELAY {1} \
 ] $axi_iic_0
  ...
  connect_bd_net -net rst_ps7_0_102M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_102M/peripheral_aresetn]
