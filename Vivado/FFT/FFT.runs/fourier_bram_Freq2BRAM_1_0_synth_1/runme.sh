...
HD_PWD='D:/Uni/git/ABP/Vivado/FFT/FFT.runs/fourier_bram_Freq2BRAM_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourier_bram_Freq2BRAM_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourier_bram_Freq2BRAM_1_0.tcl
