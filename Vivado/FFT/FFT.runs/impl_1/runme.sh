...
HD_PWD='D:/Uni/git/ABP/Vivado/FFT/FFT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourier_bram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourier_bram_wrapper.tcl -notrace
