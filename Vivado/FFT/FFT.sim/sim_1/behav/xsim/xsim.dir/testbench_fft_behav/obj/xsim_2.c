...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPISetCallerName(0, "/home/niklas/dev/uni/ABP/git/Vivado/FFT/FFT.srcs/sim_1/new/testbench_complex_mul.sv") ;
		DPISetCallerLine(0, 77) ;
		DPISetCallerOffset(0, 0) ;
		DPISetCallerName(1, "/home/niklas/dev/uni/ABP/git/Vivado/FFT/FFT.srcs/sim_1/new/testbench_complex_mul.sv") ;
		DPISetCallerLine(1, 78) ;
		DPISetCallerOffset(1, 0) ;
		DPIAllocateDPIScopes(2) ;
		DPISetDPIScopeFunctionName(0, "cos") ;
		DPISetDPIScopeHierarchy(0, "testbench_fft") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x71e00)) ;
		DPISetDPIScopeFunctionName(1, "sin") ;
		DPISetDPIScopeHierarchy(1, "testbench_fft") ;
		DPIRelocateDPIScopeIP(1, (char*)(0x71e00)) ;
	}
