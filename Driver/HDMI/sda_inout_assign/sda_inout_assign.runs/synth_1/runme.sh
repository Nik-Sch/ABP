...
HD_PWD='/home/steffnet/Schreibtisch/ABP/Driver/HDMI/sda_inout_assign/sda_inout_assign.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sda_in_out_to_inout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sda_in_out_to_inout.tcl
