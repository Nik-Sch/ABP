...
proc create_root_design { parentCell } {
  ...
  set sda_i_o_0 [ create_bd_port -dir IO sda_i_o_0 ]
  ...
  # Create instance: sda_in_out_to_inout_0, and set properties
  set sda_in_out_to_inout_0 [ create_bd_cell -type ip -vlnv user.org:user:sda_in_out_to_inout:1.0 sda_in_out_to_inout_0 ]
  ...
  connect_bd_net -net Net [get_bd_ports sda_i_o_0] [get_bd_pins sda_in_out_to_inout_0/sda_i_o]
  connect_bd_net -net axi_iic_0_scl_o [get_bd_pins axi_iic_0/scl_o] [get_bd_pins sda_in_out_to_inout_0/sda_o]
  connect_bd_net -net axi_iic_0_scl_t [get_bd_pins axi_iic_0/scl_t] [get_bd_pins sda_in_out_to_inout_0/sda_t]
  connect_bd_net -net axi_iic_0_sda_o [get_bd_ports sda_o_0] [get_bd_pins axi_iic_0/sda_o]
  ...
  connect_bd_net -net rst_ps7_0_102M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_102M/peripheral_aresetn]
  connect_bd_net -net sda_i_0_1 [get_bd_ports sda_i_0] [get_bd_pins axi_iic_0/sda_i]
  connect_bd_net -net sda_in_out_to_inout_0_sda_i [get_bd_pins axi_iic_0/scl_i] [get_bd_pins sda_in_out_to_inout_0/sda_i]
