...
HD_PWD='/home/steffnet/Schreibtisch/ABP/Driver/HDMI/hdmi/hdmi.runs/sda_in_out_to_inout_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sda_in_out_to_inout_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sda_in_out_to_inout_0.tcl
