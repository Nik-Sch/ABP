...
proc create_root_design { parentCell } {
  ...
  set DAC_SDATA [ create_bd_port -dir I DAC_SDATA ]
  set FCLK_CLK1_0 [ create_bd_port -dir O -type clk FCLK_CLK1_0 ]
  set LRCLK [ create_bd_port -dir I LRCLK ]
  set debug_led [ create_bd_port -dir O debug_led ]
  set debug_led1 [ create_bd_port -dir O debug_led1 ]
  set debug_led2 [ create_bd_port -dir O debug_led2 ]
  set debug_led3 [ create_bd_port -dir O debug_led3 ]
  set debug_led4 [ create_bd_port -dir O debug_led4 ]
  set debug_led5 [ create_bd_port -dir O debug_led5 ]

  # Create instance: audio_receiver_0, and set properties
  set audio_receiver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:audio_receiver:1.0 audio_receiver_0 ]
  ...
  connect_bd_net -net BCLK_1 [get_bd_ports BCLK] [get_bd_ports debug_led2] [get_bd_pins audio_receiver_0/bclk]
  connect_bd_net -net DAC_SDATA_1 [get_bd_ports DAC_SDATA] [get_bd_ports debug_led4]
  connect_bd_net -net LRCLK_1 [get_bd_ports LRCLK] [get_bd_ports debug_led1] [get_bd_pins audio_receiver_0/lrclk]
  connect_bd_net -net SDATA_1 [get_bd_ports ADC_SDATA] [get_bd_ports debug_led3] [get_bd_pins audio_receiver_0/sdata]
  connect_bd_net -net audio_receiver_0_sample_good [get_bd_ports debug_led5] [get_bd_pins audio_receiver_0/sample_good]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports debug_led] [get_bd_pins audio_receiver_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins audio_receiver_0/rst] [get_bd_pins xlconstant_0/dout]
